/**
* WPApi
* Copyright 2020 Francesco Pepe, Matthew J. Clemente, John Berquist
* Licensed under MIT (https://mit-license.org)
*/
component displayname="WPApi"  {

    variables._wpapi_version = '0.0.0'; 
    ...
    */
    ...
    private struct function getBaseHttpHeaders() {
        return {
            ...
            'User-Agent' : 'WPApi/#variables._wpapi_version# (ColdFusion)'
        };
    }
