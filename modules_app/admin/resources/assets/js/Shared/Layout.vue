          ...
          <div class="bg-white border-b w-full p-4 md:py-0 md:px-12 text-sm md:text-base flex justify-between items-center">
            ...
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <div slot="dropdown" class="mt-2 py-2 shadow-lg bg-white rounded text-sm">
                <inertia-link class="block px-6 py-2 hover:bg-indigo hover:text-white" href="/admin/profile">My Profile</inertia-link>
                <inertia-link class="block px-6 py-2 hover:bg-indigo hover:text-white" href="/admin/logout" method="post">Logout</inertia-link>
              </div>
            </dropdown>
          </div>
        </div>
